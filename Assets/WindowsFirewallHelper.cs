...
public static class WindowsFirewallHelper
{
    ...
    {
        TryAddRuleIfNotExists("Deep-LAN-UDP", 7772, "UDP");
        TryAddRuleIfNotExists("Deep-Game-UDP", 7771, "UDP");
        TryAddRuleIfNotExists("Deep-Game-TCP", 7771, "TCP");
    }

    public static void OpenClientPorts()
    {
        TryAddRuleIfNotExists("Deep-LAN-UDP", 7771, "UDP");
    }
